...
3. Open a new issue if you don’t find a match. Include:
    - A clear description of the problem.
    - Steps to reproduce.
    - Your environment details (OS, QIT CLI version).
...
- Suggesting new features or integrations.
- Noting any documentation gaps or unclear sections.
