...
const sidebars = {
    docsSidebar: [
        ...
        },
        {
            ...
            collapsed: true,
            items: [
                'custom-tests-specification/introduction',
                {
                    type: 'category',
                    label: 'Quick Start',
                    collapsed: true,
                    items: [
                        'custom-tests-specification/quick-start/new-playwright',
                        'custom-tests-specification/quick-start/existing-playwright',
                        'custom-tests-specification/quick-start/other-frameworks',
                    ],
                },
                'custom-tests-specification/architecture',
                'custom-tests-specification/specification',
            ],
        },
        {
            type: 'category',
